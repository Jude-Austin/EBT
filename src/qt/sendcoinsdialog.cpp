    ...
    model(0)
{
	...
	ui->editTxComment->setPlaceholderText(tr("Enter a transaction comment (This information is NOT public)"));
        ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter an EBT address (e.g. 5ggxno5wZyVWyJ7hXsGTNzAsNHFnfWYA3P)"));
#endif
